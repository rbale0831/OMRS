...
router.get('/listPatientDetails', hospitalAuth, checkHospital,hospitalController.hospitalListPatientDetails_get);
router.get('/addPatientDetails', hospitalAuth, checkHospital,hospitalController.hospitalAddListPatientDetails_get);
